...
export const PITCHER_IDS = Object.keys(PITCHERS).sort((a, b) => PITCHERS[a].level - PITCHERS[b].level);
export const DEFAULT_PITCHER = 'rookie';
export const isPitcherId = (v) => typeof v === 'string' && PITCHER_IDS.includes(v);
export const unlockedPitchers = (level) => PITCHER_IDS.filter((id) => PITCHERS[id].level <= level);
/**
